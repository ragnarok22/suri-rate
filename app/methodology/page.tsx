      ...
      <div className="container mx-auto px-4 py-12 space-y-10">
        ...
        <header className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
            Here is the lifecycle from fetching to displaying every exchange
            rate inside SuriRate.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-green-100 dark:border-green-900 bg-white/90 dark:bg-gray-800/90 p-6 shadow-sm space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            We scan all USD and EUR quotes, track the highest buy price and
            lowest sell price, and label them &quot;Best&quot; on the dashboard.
            This ensures you notice outliers instantly while still seeing each
            bank&apos;s spread.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
